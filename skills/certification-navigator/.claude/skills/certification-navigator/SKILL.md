...
# Certification Navigator — Claude Code wrapper

This is the **Claude Code wrapper** for `certification-navigator`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
