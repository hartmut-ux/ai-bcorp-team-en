---
name: climate-action-planner
description: >
---

# Climate Action Planner — Codex CLI wrapper

This is the **Codex CLI wrapper** for `climate-action-planner`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.

## When to use

Use when the user asks for:
- `climate-action-planner`
- "run climate-action-planner"
