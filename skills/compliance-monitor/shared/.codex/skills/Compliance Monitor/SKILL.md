...
# Compliance Monitor — Codex CLI wrapper

This is the **Codex CLI wrapper** for `Compliance Monitor`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
