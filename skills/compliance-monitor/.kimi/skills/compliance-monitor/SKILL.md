...
# Compliance Monitor — Kimi Code CLI wrapper

This is the **Kimi Code CLI wrapper** for `compliance-monitor`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
