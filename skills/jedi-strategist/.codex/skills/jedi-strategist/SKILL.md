...
# Jedi Strategist — Codex CLI wrapper

This is the **Codex CLI wrapper** for `jedi-strategist`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
