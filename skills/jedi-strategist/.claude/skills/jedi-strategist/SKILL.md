...
# Jedi Strategist — Claude Code wrapper

This is the **Claude Code wrapper** for `jedi-strategist`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
