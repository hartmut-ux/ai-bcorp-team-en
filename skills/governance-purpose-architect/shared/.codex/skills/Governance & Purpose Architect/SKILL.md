...
# Governance & Purpose Architect — Codex CLI wrapper

This is the **Codex CLI wrapper** for `Governance & Purpose Architect`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
