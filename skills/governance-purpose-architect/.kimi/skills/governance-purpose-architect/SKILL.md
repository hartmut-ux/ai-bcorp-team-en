...
# Governance Purpose Architect — Kimi Code CLI wrapper

This is the **Kimi Code CLI wrapper** for `governance-purpose-architect`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.

## When to use

Use when the user asks for:
- `/governance-purpose-architect`
- "run governance-purpose-architect"
