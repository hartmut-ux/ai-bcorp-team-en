...
# Fair Work Analyst — Codex CLI wrapper

This is the **Codex CLI wrapper** for `Fair Work Analyst`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
