...
# Fair Work Analyst — Kimi Code CLI wrapper

This is the **Kimi Code CLI wrapper** for `fair-work-analyst`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.

## When to use

Use when the user asks for:
- `/fair-work-analyst`
- "run fair-work-analyst"
