...
# Environmental Stewardship Manager — Claude Code wrapper

This is the **Claude Code wrapper** for `environmental-stewardship-manager`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.

## When to use

Use when the user asks for:
- `environmental-stewardship-manager`
- "run environmental-stewardship-manager"
