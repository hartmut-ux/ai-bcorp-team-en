...
# Environmental Stewardship Manager — Codex CLI wrapper

This is the **Codex CLI wrapper** for `Environmental Stewardship Manager`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
