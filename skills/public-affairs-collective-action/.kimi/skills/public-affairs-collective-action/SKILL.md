...
# Public Affairs Collective Action — Kimi Code CLI wrapper

This is the **Kimi Code CLI wrapper** for `public-affairs-collective-action`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.

## When to use

Use when the user asks for:
- `/public-affairs-collective-action`
- "run public-affairs-collective-action"
