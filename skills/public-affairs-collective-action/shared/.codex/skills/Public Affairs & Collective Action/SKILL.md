...
# Public Affairs & Collective Action — Codex CLI wrapper

This is the **Codex CLI wrapper** for `Public Affairs & Collective Action`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
