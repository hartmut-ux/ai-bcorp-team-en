...
# Human Rights Due Diligence — Claude Code wrapper

This is the **Claude Code wrapper** for `human-rights-due-diligence`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
